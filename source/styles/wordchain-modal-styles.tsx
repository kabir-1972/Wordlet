...
type wordleStyleProps={
  ...
  let gameAwardInfo=RewardsData.WordChains;

export const CompleteWordChainsModal=(props:wordleStyleProps)=>{
    ...
    return(
        <View>
            ...
            <View style={styles.difficultyTabs}>
                <DifficultyTabs mode = "Offline\n(Computer)" difficultyChooseBtn = {()=>handlePress(1)} selected={selected===1} difficultyTabImage={props.difficultyTabImage} disabled={props.level<XpLevelToUnlockGameMode.WordChains[1]} ></DifficultyTabs>
                <DifficultyTabs mode = "Offline\n(Two Players)" difficultyChooseBtn = {()=>handlePress(2)} selected={selected===2} difficultyTabImage={props.difficultyTabImage} disabled={props.level<XpLevelToUnlockGameMode.WordChains[2]} ></DifficultyTabs>
                <DifficultyTabs mode = "Multiplayer\n(Random)" difficultyChooseBtn = {()=>handlePress(3)} selected={selected===3} difficultyTabImage={props.difficultyTabImage} disabled={props.level<XpLevelToUnlockGameMode.WordChains[3]} ></DifficultyTabs>
                <DifficultyTabs mode = "Multiplayer\n(With Friend)" difficultyChooseBtn = {()=>handlePress(4)} selected={selected===4} difficultyTabImage={props.difficultyTabImage} disabled={props.level<XpLevelToUnlockGameMode.WordChains[4]} ></DifficultyTabs>
                </View>
...
function showUnlockingPromptMessage(xpLevel: number){
    let statement;
     ...
     xpLevel<XpLevelToUnlockGameMode.WordChains[1]?statement=`You need to reach Experience Level ${XpLevelToUnlockGameMode.WordChains[1]} to Unlock Offline (Computer) Mode`:
     xpLevel<XpLevelToUnlockGameMode.WordChains[2]?statement=`You need to reach Experience Level ${XpLevelToUnlockGameMode.WordChains[2]} to Unlock Offline (Two Players) Mode`:
     xpLevel<XpLevelToUnlockGameMode.WordChains[3]?statement=`You need to reach Experience Level ${XpLevelToUnlockGameMode.WordChains[3]} to Unlock Multiplayer (Random) Mode`:
     xpLevel<XpLevelToUnlockGameMode.WordChains[4]?statement=`You need to reach Experience Level ${XpLevelToUnlockGameMode.WordChains[4]} to Unlock Multiplayer (with Friend) Mode`:statement='';
    return statement;
}
