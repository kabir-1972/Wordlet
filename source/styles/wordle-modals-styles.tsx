...
export const CompleteWordleModal=(props:wordleStyleProps)=>{
  const [selected, setSelected] = useState(1);
  WordleChoice.gameMode=props.gameMode;
  const handlePress = (key: number) => {
    setSelected(key);
    WordleChoice.difficulty = key;
    switch(key){
