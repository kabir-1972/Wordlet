...
import { Searchup, UniversalExample} from './Searchup-GameInfo-SubScreen';
                ...
                <View style={modalStyles.header}>
                  ...
                  <View style={modalStyles.modalContent}>
                    ...
                    <View style={modalStyles.modalSubContent}>
                        <ModalContentText>Find and highlight all hidden words in the letter grid. Words can be placed in any direction and may appear forwards, backwards, diagonally, or vertically/horizontally.</ModalContentText>
                    </View>
