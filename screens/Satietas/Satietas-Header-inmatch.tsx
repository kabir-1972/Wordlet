...
import { Orthographia} from './Satietas-GameInfo-SubScreen';
...
export const OrthographiaGameInfoModal=(props: GameInfoModalProps)=>{
    return (
        <Modal
                ...
                <View style={modalStyles.header}>
                  ...
                  <View style={modalStyles.modalContent}>
                    ...
                    <View style={modalStyles.modalSubContent}>
                        <ModalContentText>Find the proper word from the title that has the most number of synonyms [or antonyms] in the scrambled list below</ModalContentText>
                    </View>
