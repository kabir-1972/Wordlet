...
import { WordLadder} from './WordLadder-GameInfo-SubScreen';
...
export const WordLadderGameInfoModal=(props: GameInfoModalProps)=>{
    return (
        <Modal
                ...
                <View style={modalStyles.header}>
                  ...
                  <View style={modalStyles.modalContent}>
                    ...
                    <View style={modalStyles.modalSubContent}>
                        <ModalContentText>Transform a start word into an end word, changing only one letter at a time, so that each intermediate word is a valid word from the dictionary.</ModalContentText>
                    </View>
                    ...
                    <ParagraphText style={{color: '#dcf9f5'}}>Assistance</ParagraphText>
                            ...
                            <ModalContentText>
                               The light bulb quickly figures out the last word, that you have not seen found out and inserts into the ladder. It does not know what words you have chosen. It only cares about how many words you have found out.
                            </ModalContentText>
                                </View>
                            </View>

                    <ParagraphText style={{color: '#dcf9f5'}}>The Check Button</ParagraphText>
                        <View style={modalStyles.modalSubParagraph}>
                            <ModalContentText>The Check Button only checks if the word you have just written is a valid word, a word already in the ladder or is correctly created following the rules based on the previous word in the ladder. It does not check whether the word fits in the ladder or not.
                            </ModalContentText>
                        </View>
