...
import { ArcadeCrossword, ReverseWordle, MultiplayerWordle, ShiftedWordle, PreSolvedWordle,
  UniversalExample
...
export const CrosswordGameInfoModal=(props: GameInfoModalProps)=>{
    const [triggerLightSweep, setTriggerLightSweep]=useState(true);
    setTimeout(()=>{
        setTriggerLightSweep(!triggerLightSweep);},550);
        
    let subScreen;
    let exampleScreen=UniversalExample;

    switch(true){
        case props.gameName.includes("Basic"): subScreen=ArcadeCrossword;  /*exampleScreen=ArcadeCrosswordExample;*/ break;
        case props.gameName.includes("Reverse"): subScreen=ReverseWordle;  /*exampleScreen=ReverseWordleExample;*/ break;
        case props.gameName.includes("Shifted"): subScreen=ShiftedWordle; /*exampleScreen=ShiftedWordleExample;*/ break;
        case props.gameName.includes("Solved"): subScreen=PreSolvedWordle; /*exampleScreen=PreSolvedWordleExample;*/ break;
        case props.gameName.includes("Multiplayer"): subScreen=MultiplayerWordle; /*exampleScreen=MultiplayerWordleExample;*/ break;
        default: subScreen=ArcadeCrossword; /*exampleScreen=ArcadeCrosswordExample;*/ break;
    }
                ...
                <View style={modalStyles.header}>
                  ...
                  <View style={modalStyles.modalContent}>
                    ...
                    <View style={modalStyles.modalSubContent}>
                        <ModalContentText>Fill the boxes with words in English taking help from the clues.</ModalContentText>
                    </View>
                    ...
                    <View style={modalStyles.horizontalBar}></View>
                    {exampleScreen()}    
                    <ParagraphText style={{color: '#dcf9f5'}}>Assistance</ParagraphText>
                        <View style={[modalStyles.modalSubParagraph, {backgroundColor: '#e1fbeb'}]}>
                            ...
                            <ModalContentText>The wand fills an empty box [empty or not, selected by the user] in the crossword.</ModalContentText>
                            </View>
                            <View style={{alignItems: 'center'}}>
                            <View style={{flexDirection: 'row', alignItems: 'center', gap: 3}}>
                            <ModalContentText>Cost: 10</ModalContentText>
                            <Image
                            source={icons.coin}
                        ...
                        <View style={[modalStyles.modalSubParagraph, {backgroundColor: '#e1fbeb'}]}>
                            ...
                            <ModalContentText>The wand fills an grid [empty or not, selected by the user] in the crossword.</ModalContentText>
                            </View>
                            <View style={{alignItems: 'center'}}>
                            <View style={{flexDirection: 'row', alignItems: 'center', gap: 3}}>
                            <ModalContentText>Cost: 60</ModalContentText>
                            <Image
                            source={icons.coin}
                            style={{width: 15, height: 15}}
                            ></Image>
                        ...
                        <View style={[modalStyles.modalSubParagraph, {backgroundColor: '#e1fbeb'}]}>
                            ...
                            <ModalContentText>This wand checks the grid by putting a cross-mark
                            {"  "}<Image source={icons.redCrossIcon} style={{width: 10, height: 10, marginHorizontal: 12}}></Image>{"  "} 
                            or a tick-mark
                            {"  "}<Image source={icons.greenTickIcon} style={{width: 10, height: 10, marginHorizontal: 12}}></Image>{"  "}
                            at the upper right corner in each of the boxes of the grid. For every levels, the first three grid checks are free. The next checks each costs 50 coins. It does not depend on how large or small the grid is.
                            </ModalContentText>
                            </View>
                            <View style={{alignItems: 'center'}}>
                            <View style={{flexDirection: 'row', alignItems: 'center', gap: 3}}>
