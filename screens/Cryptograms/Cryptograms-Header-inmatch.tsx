...
import { Cryptogram, UniversalExample} from './Cryptograms-GameInfo-SubScreen';
import { AddCoinModal } from '../Add-Coin-Modal'
import { SettingsData, SettingsModal } from '../Settings';
import { ProfileModal } from '../Profile';
import { Costs } from '../Rewards';
                ...
                <View style={modalStyles.header}>
                  ...
                  <View style={modalStyles.modalContent}>
                    ...
                    <View style={modalStyles.modalSubContent}>
                        <ModalContentText>You are given a coded message where each letter of the original text has been replaced by a different letter. Your goal is to decode the message by figuring out which cipher letter corresponds to which original letter.</ModalContentText>
                    </View>
                    ...
                    <ParagraphText style={{color: '#dcf9f5'}}>Assistance</ParagraphText>
                        <View style={[modalStyles.modalSubParagraph, {backgroundColor: '#e1fbeb'}]}>
                            ...
                            <ModalContentText>The witty bulb finds out a word for you in the sentence.</ModalContentText>
                            </View>
                            <View style={{alignItems: 'center'}}>
                            <View style={{flexDirection: 'row', alignItems: 'center', gap: 3}}>
                            <ModalContentText>Cost: {Costs.Cryptogram}</ModalContentText>
                            <Image
                            source={icons.coin}
