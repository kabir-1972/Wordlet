...
const SettingsModal = () => {
  ...
  const onSoundChange = (value: number) => {sound.value=value};
  const onMusicChange = (value: number) => {music.value=value};
  const onVoiceChange = (value: number) => {voice.value=value};
  ...
  const [gameInfoModalVisible, setGameInfoModalVisible]=useState(true);
...
const updateLanguage=(option: number)=>{
  ...
  return (
    ...
    >
      <Button title="Open Modal" onPress={() => setModalVis(true)} />
      <WordleText>Bangladesh--</WordleText>
      <Modal
        visible={modalVis}
                ...
                <WordleText style={styles.accountConnectPrompt}>Keep your profile linked with an account so that you can continue playing in other devices</WordleText>
                  ...
                  <SettingsHeader header='Notifications' headerBgColor='#ebbdff'/>
                    <View style={{marginHorizontal: 10, marginVertical: 5}}>
                      <Notifications notifyText="Inform me when I receive system messages" value={SettingsData.notifications[1]}/>
                      <Notifications notifyText="Inform me when I receive messages from players" value={SettingsData.notifications[2]}/>
                      <Notifications notifyText="Inform me when I receive friendly challenges" value={SettingsData.notifications[3]}/>
                      <Notifications notifyText="Inform me when my bet is matched" value={SettingsData.notifications[4]}/>
                      <Notifications notifyText="Inform me when any new tournament is available" value={SettingsData.notifications[5]}/>
                      <Notifications notifyText="Inform me when my crosswords are attempted by others" value={SettingsData.notifications[6]}/>
                      <Notifications notifyText="Inform me when my flashcards are saved by others" value={SettingsData.notifications[7]}/>
                    </View>
...
const SettingsHeader=(props: SettingsHeaderProps)=>{
  return (
    <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginLeft: 10, marginVertical: 5}}>
        <WordleText style={{backgroundColor: props.headerBgColor, paddingVertical: 2, paddingHorizontal: 4, borderRadius: 4}}>{props.header}</WordleText>
